...
def main():
    ...
    previous_sections = {}
    for section_name in ["Business Context", "Problem Statement", "Objectives"]:
    ...
    with open(f"x_results/deliverables_{timestamp}.txt", "w", encoding="utf-8") as f:
        f.write(content)
    print(f"\n✅ Saved to x_results/deliverables_{timestamp}.txt")
